<footer class="blog-footer">
    ...
    <div class="footer-end">
        <div class="container">
            <div class="row">
                <div class="col-sm-6 hidden-xs-down contacts-col">
                    <div class="contacts">
                        ...
                        <p>Тел. 62-30-51, 62-34-61</p>
                        <p><a href="mailto:zal.akademic@ukr.net">zal.akademic@ukr.net</a></p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <p class="copyright">&copy <?php echo date('Y'); ?> Запорізький Академічний ліцей. Всі права збережені.</p>
                    <p class="design-by"><a href="https://vk.com/snosme" target="_blank">Дизайн: Дроздов Олександр</a></p>
                </div>
            </div>
        </div>
    </div>
